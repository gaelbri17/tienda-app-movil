...
const openCreate = () => {
    ...
    SAVE_MODAL.show();
    MODAL_TITLE.textContent = 'Create a client';
...
const openUpdate = async (id) => {
    ...
    if (DATA.status) {
        // Se muestra la caja de diálogo con su título.
        SAVE_MODAL.show();
        MODAL_TITLE.textContent = 'Update client';
        // Se prepara el formulario.
        SAVE_FORM.reset();
...
const openDelete = async (id) => {
    ...
    const RESPONSE = await confirmAction('¿You want to delete the customer permanently?');
