...
const SAVE_FORM = document.getElementById('saveForm'),
    ...
    CATEGORIA_TALLA = document.getElementById('talla');
...
const openCreate = () => {
    ...
    SAVE_MODAL.show();
    MODAL_TITLE.textContent = 'Create size';
    // Se prepara el formulario.
    SAVE_FORM.reset();
    fillSelect(TIPO_TALLA_API, 'readAll', 'idTipoTalla');
}
...
const openUpdate = async (id) => {
    ...
    if (DATA.status) {
        // Se muestra la caja de diálogo con su título.
        SAVE_MODAL.show();
        MODAL_TITLE.textContent = 'Update sizes';
        // Se prepara el formulario.
        SAVE_FORM.reset();
        // Se inicializan los campos con los datos.
        const ROW = DATA.dataset;
        ID_TALLA.value = ROW.id_talla;
        CATEGORIA_TALLA.value = ROW.talla;
        fillSelect(TIPO_TALLA_API, 'readAll', 'idTipoTalla', ROW.id_tipo_talla);
...
const openDelete = async (id) => {
    ...
    const RESPONSE = await confirmAction('¿You want to remove the size permanently?');
