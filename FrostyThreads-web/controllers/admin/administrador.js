...
const SAVE_FORM = document.getElementById('saveForm'),
    ...
    TIPO_ADMINISTRADOR = document.getElementById('idTipoAdministrador'),
        ...
        DATA.dataset.forEach(row => {
            ...
            TABLE_BODY.innerHTML += `
                <tr>
                    ...
                    <td>${row.id_tipo_administrador}</td>                    
                    <td>
...
const openCreate = () => {
    ...
    SAVE_MODAL.show();
    MODAL_TITLE.textContent = 'Create administrator';
    // Se prepara el formulario.
    SAVE_FORM.reset();
    CLAVE_ADMINISTRADOR.disabled = false;
    fillSelect(TIPO_ADMINISTRADOR_API, 'readAll', 'idTipoAdministrador');
}
...
const openUpdate = async (id) => {
    ...
    if (DATA.status) {
        // Se muestra la caja de diálogo con su título.
        SAVE_MODAL.show();
        MODAL_TITLE.textContent = 'Update administrator';
        // Se prepara el formulario.
        SAVE_FORM.reset();
        ...
        fillSelect(TIPO_ADMINISTRADOR_API, 'readAll', 'idTipoAdministrador', ROW.id_tipo_administrador);
    } else {
        sweetAlert(2, DATA.error, false);
    }
}
...
const openDelete = async (id) => {
    ...
    const RESPONSE = await confirmAction('¿You want to delete the administrator permanently?');
