...
const SERVER_URL = 'http://localhost/FrostyThreads/api/';
...
*   Retorno: ninguno.
*/
const fillSelect = async (filename, action, select, filter = undefined, campo = 1, valor = 0) => {
...
const logOut = async () => {
    ...
    const RESPONSE = await confirmAction('¿Do you want to log out?');
